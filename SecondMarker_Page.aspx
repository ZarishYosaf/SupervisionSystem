<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.Master" AutoEventWireup="true" CodeBehind="SecondMarker_Page.aspx.cs" Inherits="FinalProject.admin.SecondMarker_Page" %>
                            ...
                            <div class="col-md-6 col-lg-7">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>ADD Second Marker </strong> </h2>
                                    </div>
                                    <!-- END Updates Title -->
                                            ...
                                            <div class="row">
                                               <div class="col-md-6 form-group"> 
                                                ...
                                                <asp:TextBox ID="txtEmail" runat="server"  CssClass="form-control"></asp:TextBox>
                                                   <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid Email!" Display="Dynamic" ForeColor="Red" SetFocusOnError="True" ControlToValidate="txtEmail" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
                                            </div>
                                                <div class="col-md-6 form-group"> 
